...
function StopWatch() {
    ...
    return (
        <main className='grid grid-cols-1 place-items-center bg-gray-100 h-screen m-auto'>
            <div className='bg-gray-300 w-[100%] h-[100%] md:w-[90%] md:h-[70%] lg:w-[70%] lg:h-[60%] xl:w-[50%] 2xl:w-[40%] 2xl:h-[64%] md:px-10 md:py-6 grid grid-cols-1 lg:grid-cols-3 grid-rows-6 lg:grid-rows-4 lg:gap-8 grid-flow-col lg:grid-flow-row'>
                ...
                <div className='row-span1 lg:row-span-4  text-white flex flex-col gap-1 lg:gap-6 w-[100%]'>
                    <button
                ...
                <div className='col-span-2 p-4 row-span-4 max-h-96 overflow-scroll my-10 lg:my-0'>
